...
insert into post_questions(post_id, question_id) VALUES (1, 3);
insert into post_questions(post_id, question_id) VALUES (1, 4);

insert into post_questions(post_id, question_id) VALUES (2, 2);
insert into post_questions(post_id, question_id) VALUES (2, 3);
insert into post_questions(post_id, question_id) VALUES (2, 5);

insert into post_questions(post_id, question_id) VALUES (3, 1);
insert into post_questions(post_id, question_id) VALUES (3, 2);
